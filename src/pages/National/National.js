  ...
  return (
    <div>
      <div>
        ...
        <meta
          property="og:image"
          content="images/Hieroglyphs_at_Ferens_Art_Gallery_Hull_1.jpg"
        />
                    ...
                    <div className="hero__background">
                      <div className="media media-hero media-image js-media">
                        <picture>
                          ...
                          <source
                            srcSet="images/Hieroglyphs_at_Ferens_Art_Gallery_Hull_2.jpg 1x"
                          ...
                          />
                          <source
                            srcSet="images/Hieroglyphs_at_Ferens_Art_Gallery_Hull_1.jpg 1x"
                          ...
                          />
                          <source
                            srcSet="images/Hieroglyphs_at_Ferens_Art_Gallery_Hull_3.jpg 1x"
                          ...
                          <img
                            ...
                            src="images/Hieroglyphs_at_Ferens_Art_Gallery_Hull.jpg"
                            ...
                            <ul className="menu menu--level-0 menu--footer">
                              ...
                              <li className="menu-item menu-item--expanded menu-item--active-trail menu__item--level-0">
                                ...
                                <ul className="menu menu--level-1">
                                  ...
                                  <li className="menu-item menu-item--collapsed menu-item--active-trail menu__item--level-1">
                                    <a
                                      className="menu__link menu__link--level-1"
