                                    ...
                                    >
                                      ...
                                      >
                                        <button
                                          ...
                                          data-description='<strong>Pablo Picasso (1881‒1973), &apos;The Pike II&apos;. Colour linocut, 1959. </strong><span dir="ltr"><strong>© Succession Picasso/DACS, London 2024.</strong></span><br>Curved forms and multiple colours give this print a sense of swirling dynamism. We can almost hear the commotion as the bullfighter thrusts his pike toward the bull. Picasso made this linocut in Cannes, where he bought a villa in 1955. <a href="https://www.britishmuseum.org/collection/object/P_1994-1002-10"><span>Collection online</span></a>'
                                          data-caption
                                          data-lang
                                        >
                                          <span className="visually-hidden">
                        ...
                        <div className="footer-pre__content-item footer-pre__content-item--social">
                          <div id="block-sociallinks">
                            <ul className="menu menu--icon-menu menu--level-0">
                              ...
                              <li>
                                <a
                                  href="https://weibo.com/britishmuseumlondon"
                                  target="_blank"
                                  rel="noopener"
                                  className=" external-link"
                                >
                            ...
                            <ul className="menu menu--level-0 menu--footer">
                              ...
                              <li className="menu-item menu-item--expanded menu__item--level-0">
                                ...
                                <ul className="menu menu--level-1">
                                  ...
                                  <li className="menu-item menu__item--level-1">
                                    <a
                                      className="menu__link menu__link--level-1 external-link"
                    ...
                    <div className="footer-post__nav">
                      ...
                      >
                        ...
                        <ul className="menu menu--level-0 menu--footer-legal">
                          ...
                          <li className="menu-item">
                            <a
                              className="menu__link menu__link--level-0 external-link"
